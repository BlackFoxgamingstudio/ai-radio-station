...
def main():
    parser = argparse.ArgumentParser(description="SBB Solution PKG-031: AI Radio Station")
    parser.add_argument("--health", action="store_true", help="Service health check")
    parser.add_argument("--exec", type=str, default="get_now_playing", help="Feature action name")
